...
Descarga la carpeta .zip para acceder al material de esta sesión. Haga click en el siguiente [enlace](https://downgit.github.io/#/home?url=https://github.com/aito123/CCO221_web/tree/master/semana13_ejercicio_material). No olvides unzipear el archivo.
:::
...
1. Añade la función `scale_x_log10` para que el eje `x` se vuelva logarítmico y permita graficar mejor la amplitud de datos. Necesitarás cargar el paquete {scales}.
2. Añade la función `scale_y_log10` para que el eje `y` se vuelva logarítmico y permita graficar mejor la amplitud de datos. Necesitarás cargar el paquete {scales}.
